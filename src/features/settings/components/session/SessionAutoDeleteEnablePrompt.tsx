...
export function SessionAutoDeleteEnablePrompt({
  eligibleCount,
  busy,
  error,
  onCancel,
  ...
  return (
    <ModalShell
      ...
      ariaLabel={t("settings.session.autoDeleteEnableTitle")}
    >
      <div className="ds-modal-title">
        {t("settings.session.autoDeleteEnableTitle")}
      </div>
      <div className="settings-help ds-text-danger">
        {t("settings.session.autoDeleteEnableWarning")}
      </div>
      <div>
      ...
      <div className="ds-modal-actions">
        ...
        >
          {busy
            ? t("settings.session.autoDeleteEnabling")
            : t("settings.session.autoDeleteEnableConfirm")}
        </button>
      </div>
    </ModalShell>
  );
