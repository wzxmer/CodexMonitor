...
describe("SessionDerivationPrompt", () => {
  it("previews source, destination, counts, and confirms", () => {
    ...
    const { container } = render(<SessionDerivationPrompt
      previews={[{
    ...
    expect(container.querySelector(".ds-modal-card.session-derivation-modal")).toBeTruthy();
    expect(container.querySelector(".ds-modal.session-derivation-modal")).toBeNull();
